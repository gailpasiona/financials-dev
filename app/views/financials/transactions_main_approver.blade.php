      ...
      <div class="col-md-12">
        <div class="messages"></div>
          <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-folder-open-o fa-md"></i> <strong>Approve Payables</strong></div>
              ...
              <div class="control-group pull-right">
                ...
                <div class="controls">
                  <select class="form-control" id="reload_type">
                            <option value="approval">For Invoicing </option>
...
function useractionFormatter(value){
    ...
    var url = 'AP/approval?reference=' + value;
    return '<a class="btn btn-sm btn-warning" href="'+ url +'" data-toggle="modal" data-target="#modal_form"><strong>Approve</strong></a>';
}
